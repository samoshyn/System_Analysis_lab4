...
class Solve(object):
    ...
    def poly_func(self):
        ...
        :return: function
        """
        if self.poly_type == 'Зміщені поліноми Чебишева':
            self.poly_f = eval_sh_chebyt
        elif self.poly_type == 'Поліноми Чебишева':
            self.poly_f = eval_chebyt
        elif self.poly_type == 'Зміщені полномі Чебишева 2 роду':
